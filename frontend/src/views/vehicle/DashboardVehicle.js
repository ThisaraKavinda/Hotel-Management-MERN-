...
import {getReservationsForAMonth} from '../../controllers/reservation.js';
import {getAllVehicles, getRidesForAMonth, getRideList} from '../../controllers/vehicle.js';
...
export default function DashboardPayment() {
    ...
    const [monthT, setMonth] = useState(0);
    ...
    useEffect(() => {
        ...
        let monthx = new Date().getMonth() + 1;
        setMonth(monthx)
        getReservationsForAMonth(monthx).then((res) => {
            if (res.length < 10) {
                setFoodCount("0" + res.length)
            } else 
        ...
        setMonth(monthx)
        // setFoodCount(3);
        getRidesForAMonth(monthx).then((res) => {
            if (res.length < 10) {
                        ...
                        <div class="row d-flex justify-content-between">
                            <div class="col-md-6 col-lg-4 ">
                                ...
                                <div class="card-body" style={{ margin: "0px" }}>
                                    <div class="row">
                                    <div class="col-7 mt-0 px-4 text-white">
                                        <h5 class="card-title text-white fs-5">Rides</h5>
                            ...
                            <div class="col-md-6 col-lg-4 ">
                                ...
                                <div class="card-body" style={{ margin: "0px" }}>
                                    <div class="row">
                                    <div class="col-7 mt-0 px-4 text-white">
                                        <h5 class="card-title text-white fs-5">Vehicles</h5>
                            ...
                            <div class="col-md-6 col-lg-4 ">
                                ...
                                <div class="card-body" style={{ margin: "0px" }}>
                                    ...
                                    <div class="col-6 mt-0 px-4 text-white">
                                        <h5 class="card-title text-white fs-5">Reservations</h5>
                                        <h1 class="display-5 mt-1 mb-1 text-white fw-bold" style={{ fontSize: "40px" }}>
                                        {foodCount}
                                        </h1>
                                        <h5 class="text-white fs-5">{monthName}</h5>
                                    ...
                                    <div class="card-body" style={{ margin: "0px" }}>
                                        ...
                                        <Bar
                                            ...
                                            data={{
                                                ...
                                                datasets: [{
                                                    label: 'Annual vehicle Rides Summary',
                                                    data: revenueList,
                                                    backgroundColor: [
                                                        'rgb(255, 99, 132)',
                                                        'rgb(75, 192, 192)',
