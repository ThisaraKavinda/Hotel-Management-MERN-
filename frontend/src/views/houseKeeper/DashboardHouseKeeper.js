...
import {getAllHouseKeeper, getTasksForAMonth, getTasksList} from "../../controllers/houseKeeper.js";
...
export default function DashboardHouseKeeper() {
    ...
    useEffect(() => {
        ...
        setMonth(month)
        // setFoodCount(3);
        getTasksForAMonth(month).then((res) => {
            if (res.length < 10) {
                        ...
                        <div class="row d-flex justify-content-between">
                            <div class="col-md-6 col-lg-4 ">
                                ...
                                <div class="card-body" style={{ margin: "0px" }}>
                                    ...
                                    <div class="col-7 mt-0 px-4 text-white">
                                        <h5 class="card-title text-white fs-5">Housekeepers</h5>
                                        <h1 class="display-5 mt-1 mb-1 text-white fw-bold" style={{ fontSize: "40px" }}>{foodCount}</h1>
                            ...
                            <div class="col-md-6 col-lg-4 ">
                                ...
                                <div class="card-body" style={{ margin: "0px" }}>
                                    <div class="row">
                                    <div class="col-7 mt-0 px-4 text-white">
                                        <h5 class="card-title text-white fs-5">Assigneed Tasks</h5>
                            ...
                            <div class="col-md-6 col-lg-4 ">
                                ...
                                <div class="card-body" style={{ margin: "0px" }}>
                                    ...
                                    <div class="col-6 mt-0 px-4 text-white">
                                        <h5 class="card-title text-white fs-5">Rooms</h5>
                                        <h1 class="display-5 mt-1 mb-1 text-white fw-bold" style={{ fontSize: "40px" }}>
                                        {revenue}
                                        </h1>
                                        <h5 class="text-white fs-5">{monthName}</h5>
                                    ...
                                    <div class="card-body" style={{ margin: "0px" }}>
                                        ...
                                        <Bar
                                            ...
                                            data={{
                                                ...
                                                datasets: [{
                                                    label: 'Annual Assigned Tasks Summary',
                                                    data: revenueList,
                                                    backgroundColor: [
                                                        'rgb(255, 99, 132)',
                                                        'rgb(75, 192, 192)',
