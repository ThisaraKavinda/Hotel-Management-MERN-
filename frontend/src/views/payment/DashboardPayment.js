...
import {getPaymentsForAMonth, getPaymentList} from '../../controllers/payment.js';
...
export default function DashboardPayment() {
    ...
    useEffect(() => {
        ...
        setMonth(month)
        // setFoodCount(3);
        getReservationsForAMonth(month).then((res) => {
            if (res.length < 10) {
                setFoodCount("0" + res.length)
            } else 
                setFoodCount(res.length)
        })
        getPaymentsForAMonth(month).then((res) => {
            if (res.length < 10) {
                            ...
                            <div class="col-md-6 col-lg-4 ">
                                ...
                                <div class="card-body" style={{ margin: "0px" }}>
                                    ...
                                    <div class="col-7 mt-0 px-4 text-white">
                                        <h5 class="card-title text-white fs-5">Payments</h5>
