...
export default function ReportPayment() {
    ...
    async function appointmentReportGet() {
        ...
        if (room === '') {
            ...
            setLoading(true);
            viewPaymentsOfAReservation(roomId).then((result) => {
                console.log(result);
    ...
    function downloadPDF() {
        ...
        doc.save('PaymentReport' + room +'(' + new Date().toISOString().substring(0, 10) + " " + new Date().toLocaleTimeString('en-US') + ').pdf')
    }
                            ...
                            <div class="card">
                                <div class="card-body mt-3 mb-2" style={{ margin: "0px" }} >
                                    <div class="row mb-2 px-4">
                                        <h5 class="fw-semibold">Select a reservation to generate the report</h5>
                                    </div>

                                    <div class="row  align-items-center px-4 mb-2" >
                                        <div class="mb-3 col-md-6 mb-2 ml-2">
                                            <label for="type">Current Reservations</label>
                                            <Select
                                                isClearable
                                                isSearchable
                                                options={roomList}
